...
def main():
    ...
    data_dir = '../datasets/back_cb1300sf_2/'
    ...
    f_model = './output/'
    model.save_weights(os.path.join(f_model,'cnn_model_weights_cb133sf2_back.hdf5'))

    json_string = model.to_json()
    open(os.path.join(f_model,'cnn_model_weights_cb133sf2_back.json'), 'w').write(json_string)
